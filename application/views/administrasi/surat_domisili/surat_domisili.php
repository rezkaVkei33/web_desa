...
<head>
    ...
    <title>Surat Domisili - Admin</title>
    <style>
    ...
    <?php $this->load->view('templates/topbar'); ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">SURAT DOMISILI</h1>    
                    </div>
                            ...
                            <?php $no = 1; foreach ($surat_domisili as $data): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                       ...
                                       <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapus_penduduk">
                                        <i class="fas fa-trash"></i> Hapus
                                    </button>

                                    <!-- Modal Hapus Penduduk -->
                                    <div class="modal fade" id="hapus_penduduk" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    ...
                                                    menghapus data penduduk <strong><?= htmlspecialchars($data->nomor_surat); ?></strong>?</p>
                                                </div>
